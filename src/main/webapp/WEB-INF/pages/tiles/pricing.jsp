        ...
        <div class="row">
            <div class="span6 block">
                <div class="box">
                    ...
                    <p class="answ">
                        There are many variations of passages of Lorem Ipsum available, but the randomised words which
                        don’t look even slightly believable. If you are anything embarrassing hidden in the middle of
                        text.</p>
                </div>
                <div class="box">
